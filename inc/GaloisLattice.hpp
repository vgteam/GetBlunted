#ifndef BLUNTIFIER_GALOIS_LATTICE_HPP
#define BLUNTIFIER_GALOIS_LATTICE_HPP

/**
 * \file GaloisLattice.hpp
 *
 * Defines a representation of the Galois lattice of a domino-free bipartite graph.
 */
...
#endif /* BLUNTIFIER_GALOIS_LATTICE_HPP */
